        ...
        static void Main(string[] args)
        {
            ...
            Thread thread31 = new Thread(() =>
            {
                while (true)
                {
                    ...
                    sb.Append("<a href='http://localhost:49152/'>【刷新】</a>");
                    sb.Append("<a href='http://localhost:49152/stopservice'>【停止全部任务】</a>");
                    sb.Append("<a href='http://localhost:49152/startservice'>【启动全部任务】</a>");
                    sb.Append("</br>");
                    ...
                    foreach (var item in list1)
                    {
                        ...
                        sb.AppendFormat("<a href='http://localhost:49152/pausejob?jobname={0}'>【暂停】</a>", item.Key);
                        sb.AppendFormat("<a href='http://localhost:49152/resumejob?jobname={0}'>【继续】</a>", item.Key);
                        sb.AppendFormat("<a href='http://localhost:49152/stopjob?jobname={0}'>【停止】</a>", item.Key);
                        sb.Append("</br>");
                    }
                    ...
                    {
                        sb.Append(it);
                        sb.AppendFormat("<a href='http://localhost:49152/startjob?jobname={0}'>【开始】</a>", it);
                        sb.Append("</br>");
                    }
                    ...
                    {
                        sb.Append(it);
                        sb.AppendFormat("<a href='http://localhost:49152/startjob?jobname={0}'>【加载启动】</a>", it);
                        sb.Append("</br>");
                    }
